<div>
    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-6 container-menu py-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 text-gray-700">
            <a style="border-radius: 10px; font-weight: bold; font-size: 1.5em; color:white; background-color:#da007f ;" href="{{ route('invoice', $order->id) }}">Descargar factura de compra</a>
        </div>
    </div>
</div>
@push('scripts')
