<div>
    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-6 container-menu py-8">
        ...
        <div class="order-1 lg:order-2 xl:col-span-2">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 text-gray-700">
                <button class = 'inline-flex justify-center items-center px-4 py-2 bg-pink-500
                border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-pink-600
                active:bg-pink-500 focus:outline-none focus:border-pink-500 focus:shadow-outline-pink disabled:opacity-25
                transition w-full'><a href="{{ route('invoice', $order->id) }}">Descargar factura de compra</a></button>
            </div>
        </div>
    </div>
    @push('scripts')
