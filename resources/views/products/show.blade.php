    ...
    <div class="container-menu py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    <p class="text-trueGray-700">Marca: <a class="underline capitalize hover:text-pink-500" href="">{{
                ...
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    <div class="flex items-center p-4">
                        <span class="flex items-center justify-center h-10 w-10 rounded-full bg-pink-600">
                            <i class="fas fa-truck text-sm text-white"></i>
                        </span>
                        <div class="ml-4">
                            <p class="text-lg font-semibold text-pink-600">Se hacen envíos solo a la península</p>
